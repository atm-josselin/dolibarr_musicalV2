 ...
 */
class musicalv2box extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "musicalv2@musicalv2";
    public $boxlabel;
    public $depends = array("musicalv2");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/musicalv2/class/musicalv2.class.php";

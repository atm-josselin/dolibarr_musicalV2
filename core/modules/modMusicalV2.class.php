...
class modMusicalV2 extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'! empty($conf->module1->enabled) && ! empty($conf->module2->enabled)', 'picto'=>'yourpicto@musicalv2')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array();
        ...
        /* Example:
        if (! isset($conf->musicalv2->enabled)) $conf->musicalv2->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            'langs'=>'musicalv2@musicalv2',
            ...
            'tabcond'=>array($conf->musicalv2->enabled,$conf->musicalv2->enabled,$conf->musicalv2->enabled)												// Condition to show each dictionary
        );
        */
...
/*
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'musicalv2_read';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
		...
		$this->rights[$r][0] = $this->numero . $r;	// Permission id (must not be already used)
		$this->rights[$r][1] = 'musicalv2_write';	// Permission label
		$this->rights[$r][3] = 1; 					// Permission by default for new user (0/1)
...
*/
		...
		//							'titre'=>'MusicalV2 left menu',
		//							'mainmenu'=>'musicalv2',
		//							'leftmenu'=>'musicalv2_left',			// Goes into left menu previously created by the mainmenu
		//							'url'=>'/musicalv2/pagelevel2.php',
		//							'langs'=>'musicalv2@musicalv2',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
...
/*
		$this->menu[$r]=array(	
			...
			'type'=>'top',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuMusicalV2'),
			'mainmenu'=>'musicalv2',
			'leftmenu'=>'',
			'url'=>'/musicalv2/list.php',
			'langs'=>'musicalv2@musicalv2',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->musicalv2->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
			'perms'=>'$user->rights->musicalv2->read',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2
		);
		$r++;
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=musicalv2',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuMusicalV2'),
			'mainmenu'=>'musicalv2',
			'leftmenu'=>'musicalv2_left',
			'url'=>'/musicalv2/list.php',
			'langs'=>'musicalv2@musicalv2',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->musicalv2->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=musicalv2,fk_leftmenu=musicalv2_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuMusicalV2Create'),
			'mainmenu'=>'musicalv2',
			'leftmenu'=>'musicalv2_left_create',
			'url'=>'/musicalv2/card.php?action=create',
			'langs'=>'musicalv2@musicalv2',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->musicalv2->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
			'perms'=> '$user->rights->musicalv2->write',			                // Use 'perms'=>'$user->rights->missionorder->level1->level2' if you want your menu with a permission rules
			'target'=>'',
			'user'=>2
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=musicalv2,fk_leftmenu=musicalv2_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuMusicalV2List'),
			'mainmenu'=>'musicalv2',
			'leftmenu'=>'musicalv2_left_list',
			'url'=>'/musicalv2/list.php',
			'langs'=>'musicalv2@musicalv2',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->musicalv2->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
